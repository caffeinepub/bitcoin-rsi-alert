...
export class Backend implements backendInterface {
    ...
    async getDefaultOrderQuantity(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getDefaultOrderQuantity();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getKillSwitchStatus(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getKillSwitchStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasWebhookSecret(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasWebhookSecret();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async receiveWebhook(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.receiveWebhook(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setDefaultOrderQuantity(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDefaultOrderQuantity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setWebhookSecret(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setWebhookSecret(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
